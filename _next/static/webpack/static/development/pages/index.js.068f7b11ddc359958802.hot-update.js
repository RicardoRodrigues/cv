...
})(["position:absolute;top:100%;right:24px;left:24px;bottom:16px;overflow:hidden;opacity:0;filter:alpha(opacity=0);transition:all 1.2s;overflow-y:auto;font-size:16px;", ":checked ~ ", " &{top:36px;opacity:1;filter:alpha(opacity=100);}&::-webkit-scrollbar{width:14px;}&::-webkit-scrollbar-thumb{background-clip:content-box;border:4px solid transparent;border-radius:7px;box-shadow:inset 0 0 0 10px;}&::-webkit-scrollbar-button{width:0;height:0;display:none;}&::-webkit-scrollbar-corner{background-color:transparent;}> h3{font-size:14px;}"], Input, ContentHolder);
...
//# sourceMappingURL=index.js.068f7b11ddc359958802.hot-update.js.map