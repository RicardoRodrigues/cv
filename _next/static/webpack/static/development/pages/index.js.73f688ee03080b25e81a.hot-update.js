...
})(["", ";height:16px;border-radius:4px;background-color:#9ACD32;background-image:linear-gradient(to bottom,rgba(255,255,255,0.3),rgba(255,255,255,0.05));transition:2s ease-in-out;transition-delay:5s;box-shadow:0 0 1px 1px rgba(0,0,0,0.25),inset 0 1px rgba(255,255,255,0.1);}"], function (_ref) {
  var width = _ref.width,
      isVisible = _ref.isVisible;
  return isVisible && "width: ".concat(width, ";");
});
...
//# sourceMappingURL=index.js.73f688ee03080b25e81a.hot-update.js.map