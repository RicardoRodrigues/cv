...
})(["position:absolute;right:16px;top:15px;z-index:20;width:32px;height:32px;transform:rotate(0deg);transition:.5s ease-in-out;background:white;border-radius:100%;cursor:pointer;div{position:absolute;width:20px;height:20px;margin:10px 6px;}span{display:block;position:absolute;height:2px;width:100%;background:#d3531a;border-radius:2px;opacity:1;left:0;transform:rotate(0deg);transition:.25s ease-in-out;}span:nth-child(1){top:0px;transform-origin:left center;}span:nth-child(2){top:4.5px;transform-origin:left center;}span:nth-child(3){top:8px;transform-origin:left center;}", ":checked ~ & span:nth-child(1){transform:rotate(45deg);top:-0.75px;left:2px;}", ":checked ~ & span:nth-child(2){width:0%;opacity:0;}", ":checked ~ & span:nth-child(3){transform:rotate(-45deg);top:9.75px;left:2px;}"], Input, Input, Input);
...
//# sourceMappingURL=index.js.d66d407f7cbd5be2cbed.hot-update.js.map