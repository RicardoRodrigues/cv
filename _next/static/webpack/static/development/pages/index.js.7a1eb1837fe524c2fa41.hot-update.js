...
})(["box-sizing:border-box;position:absolute;top:100%;left:0;width:100%;padding:10px 16px;margin:0;z-index:10;transition:all 0.3s;color:", ";background-color:", ";", ":checked ~ &{top:0;padding:10px 16px 10px 90px;}"], _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.text.terciary, _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.background.secondary, Input);
...
var ImageHolder = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  ...
  return backgroundImage && css(_templateObject(), backgroundImage);
}, Input, ContentHolder);
...
//# sourceMappingURL=index.js.7a1eb1837fe524c2fa41.hot-update.js.map