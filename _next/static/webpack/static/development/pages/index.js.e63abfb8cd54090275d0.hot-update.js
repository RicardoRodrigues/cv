...
})(["", ";> strong{}> a{transition:.4s ease-in-out;color:", " text-decoration:underline;&:hover{", "}}"], _theme__WEBPACK_IMPORTED_MODULE_3__["default"].typography.body, _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.button.primary.normal, _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.button.primary.hover);
...
})(["margin:", " 0;"], _theme__WEBPACK_IMPORTED_MODULE_3__["default"].spacing(2));
var SKILLS = [{
  id: 1,
  name: 'HTML',
  percentage: 90
...
var About = function About(_ref) {
  ...
  }, "Cristiano Ronaldo"), " born."), __jsx("ul", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
  ...
  }, "Can't be too much far swimm in some nice beach and sun (What happen when you grow near the sea)")), __jsx("h5", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58,
...
//# sourceMappingURL=index.js.e63abfb8cd54090275d0.hot-update.js.map