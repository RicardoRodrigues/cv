...
var move = function move(width) {
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["keyframes"])(["0%{width:0;}100%{width:", ";}"], width);
};
...
})(["width:0;width:", ";height:16px;border-radius:4px;background-color:#9ACD32;background-image:linear-gradient(to bottom,rgba(255,255,255,0.3),rgba(255,255,255,0.05));animation:move 0.4s ease-in-out;animation-property:width;transition-delay:1s;box-shadow:0 0 1px 1px rgba(0,0,0,0.25),inset 0 1px rgba(255,255,255,0.1);}"], function (_ref) {
...
//# sourceMappingURL=index.js.3af58a2a73845ec9f003.hot-update.js.map