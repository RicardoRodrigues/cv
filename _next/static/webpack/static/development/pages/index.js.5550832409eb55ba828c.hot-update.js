...
})(["position:absolute;top:100%;right:24px;left:24px;bottom:16px;overflow:hidden;opacity:0;filter:alpha(opacity=0);transition:all 1.2s;overflow-y:auto;font-size:16px;text-align:justify;& h3{font-size:18px;margin-top:0;}& a{font-weight:bold;transition:.4s ease-in-out;color:", ";text-decoration:underline;&:hover{color:", ";}}", ":checked ~ ", " &{top:36px;opacity:1;filter:alpha(opacity=100);}&::-webkit-scrollbar{width:14px;}&::-webkit-scrollbar-thumb{background-clip:content-box;border:4px solid transparent;border-radius:7px;box-shadow:inset 0 0 0 10px;}&::-webkit-scrollbar-button{width:0;height:0;display:none;}&::-webkit-scrollbar-corner{background-color:transparent;}"], _theme__WEBPACK_IMPORTED_MODULE_2__["default"].palette.button.secondary.normal, _theme__WEBPACK_IMPORTED_MODULE_2__["default"].palette.button.secondary.hover, Input, ContentHolder);
...
//# sourceMappingURL=index.js.5550832409eb55ba828c.hot-update.js.map