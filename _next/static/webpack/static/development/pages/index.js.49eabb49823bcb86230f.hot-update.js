...
})(["max-width:300px;position:relative;height:0;padding-bottom:calc(100% - 120px);margin-bottom:6.6em;display:block;box-sizing:border-box;background:white;"]);
...
})(["box-sizing:border-box;position:absolute;top:100%;left:0;width:100%;padding:10px 16px;margin:0;z-index:10;transition:all 0.3s;color:", ";background-color:", ";", ":checked ~ &{top:0;padding:10px 16px 10px 75px;}"], _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.text.terciary, _theme__WEBPACK_IMPORTED_MODULE_3__["default"].palette.background.secondary, Input);
...
})(["position:absolute;top:8px;right:8px;bottom:8px;left:8px;transition:all 0.3s;", ":checked ~ &{left:7px;top:0px;width:60px;height:42px;z-index:20;}"], Input);
...
})(["overflow:hidden;position:absolute;left:0;top:0;width:100%;height:100%;z-index:3;transition:all 0.3s;", " ", ":checked ~ ", " &{border-radius:50%;left:0;top:12px;width:60px;height:60px;z-index:20;}"], function (_ref) {
...
//# sourceMappingURL=index.js.49eabb49823bcb86230f.hot-update.js.map