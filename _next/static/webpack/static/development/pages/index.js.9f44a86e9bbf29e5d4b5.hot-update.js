...
})(["position:absolute;right:16px;top:15px;z-index:20;width:60px;height:45px;margin:50px auto;transform:rotate(0deg);transition:.5s ease-in-out;cursor:pointer;span{display:block;position:absolute;height:4.5px;width:100%;background:#d3531a;border-radius:9px;opacity:1;left:0;transform:rotate(0deg);transition:.25s ease-in-out;}span:nth-child(1){top:0px;transform-origin:left center;}span:nth-child(2){top:9px;transform-origin:left center;}span:nth-child(3){top:18px;transform-origin:left center;}", ":checked ~ & span:nth-child(1){transform:rotate(45deg);top:-1.5px;left:4px;}", ":checked ~ & span:nth-child(2){width:0%;opacity:0;}", ":checked ~ & span:nth-child(3){transform:rotate(-45deg);top:19.5px;left:4px;}"], Input, Input, Input);
...
//# sourceMappingURL=index.js.9f44a86e9bbf29e5d4b5.hot-update.js.map