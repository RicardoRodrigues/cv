...
})(["position:absolute;top:100%;right:24px;left:24px;bottom:16px;overflow:hidden;opacity:0;filter:alpha(opacity=0);transition:all 1.2s;font-size:16px;", ":checked ~ ", " &{top:40px;padding-top:5.6em;opacity:1;filter:alpha(opacity=100);}"], Input, ContentHolder);
...
//# sourceMappingURL=index.js.20d3ee51384bc18341f2.hot-update.js.map