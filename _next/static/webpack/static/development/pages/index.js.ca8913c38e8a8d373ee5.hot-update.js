...
})(["position:absolute;top:8px;right:8px;bottom:8px;left:8px;transition:all 0.3s;", ":checked ~ &{top:50px;padding-top:5.6em;opacity:1;filter:alpha(opacity=100);}"], Input);
...
})(["overflow:hidden;position:absolute;left:0;top:0;width:100%;height:100%;z-index:3;transition:all 0.3s;", " ", ":checked ~ ", " &{left:0px;top:-38px;width:60px;height:42px;z-index:20;}"], function (_ref) {
...
//# sourceMappingURL=index.js.ca8913c38e8a8d373ee5.hot-update.js.map